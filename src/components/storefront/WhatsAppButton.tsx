  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" className="w-6 h-6 fill-white">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.122.55 4.112 1.516 5.842L.04 23.658a.75.75 0 00.919.938l6.034-1.579A11.94 11.94 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22a9.94 9.94 0 01-5.092-1.4l-.361-.215-3.736.979.999-3.64-.235-.374A9.943 9.943 0 012 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z" />
      </svg>
    </a>
  )
}
