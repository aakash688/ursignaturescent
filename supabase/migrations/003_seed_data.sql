...
('Midnight Wild', 'midnight-wild', 'Bold masculine freshness for the fearless', 'Midnight Wild opens with a burst of electric bergamot and sharp pepper — raw, wild, unapologetic. At its heart, lavender and geranium soften the intensity into something magnetic. The dry-down settles into warm ambroxan and cedarwood that lingers on skin for hours. This is the scent of confidence.', 'Fresh spicy citrus fragrance with ambroxan and cedarwood base. Bold, masculine, all-day wear.', 'Dior Sauvage', 'men', 'Fresh spicy, citrus, woody, amber', ARRAY['Bergamot', 'Pepper'], ARRAY['Lavender', 'Geranium'], ARRAY['Ambroxan', 'Cedarwood'], 5.0, true, true, 'Midnight Wild — Inspired by Dior Sauvage | URsignature', 'Shop Midnight Wild, a bold masculine fragrance inspired by Dior Sauvage.'),
...
UPDATE products SET images = ARRAY['/images/products/' || slug || '-1.png'] WHERE slug IN ('bloom-kiss','deep-blue','flirt-rush','game-on','kings-creed','midnight-wild','mystic-berry','royal-oud','urban-edge','velvet-desire');
